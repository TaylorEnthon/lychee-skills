---
name: tts-lychee
description: 将文本合成为 mp3 语音，支持温柔女声、东北话男声、播音员男声等多种预设音色。Use when the user asks for TTS, 配音, 朗读, 生成语音, text-to-speech, or using voices like 温柔女声、东北话男声、播音员男声。
version: 1.0.0
user-invocable: true
metadata:
  openclaw:
...
内置音色表支持常见自然语言同义词，例如“男童”“甜妹音”“小说旁白”“新闻播报男声”“性感女声”。正常回复中不要提内部映射文件。

## 常用音色

默认女声、默认男声、温柔女声、甜美女声、御姐音、低沉男声、磁性男声、少年音、儿童声、耳语女声、四川话女声、东北话男声、河南话女声、播音员男声、旁白男声、助眠女声。
